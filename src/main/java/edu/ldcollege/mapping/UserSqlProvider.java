...
import edu.ldcollege.domain.UserExample.Criteria;
import edu.ldcollege.domain.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getWorkyear() != null) {
            sql.VALUES("workYear", "#{workyear,jdbcType=INTEGER}");
        }
        ...
        if (record.getSelfintroduction() != null) {
            sql.VALUES("selfIntroduction", "#{selfintroduction,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getWorkyear() != null) {
            sql.SET("workYear = #{record.workyear,jdbcType=INTEGER}");
        }
        ...
        if (record.getSelfintroduction() != null) {
            sql.SET("selfIntroduction = #{record.selfintroduction,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getWorkyear() != null) {
            sql.SET("workYear = #{workyear,jdbcType=INTEGER}");
        }
        ...
        if (record.getSelfintroduction() != null) {
            sql.SET("selfIntroduction = #{selfintroduction,jdbcType=VARCHAR}");
        }

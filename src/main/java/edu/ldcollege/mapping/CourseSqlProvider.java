...
import edu.ldcollege.domain.CourseExample.Criteria;
import edu.ldcollege.domain.CourseExample.Criterion;
...
public class CourseSqlProvider {
    ...
    public String insertSelective(Course record) {
        ...
        if (record.getCoursetitle() != null) {
            sql.VALUES("courseTitle", "#{coursetitle,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCoursetitle() != null) {
            sql.SET("courseTitle = #{record.coursetitle,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Course record) {
        ...
        if (record.getCoursetitle() != null) {
            sql.SET("courseTitle = #{coursetitle,jdbcType=VARCHAR}");
        }

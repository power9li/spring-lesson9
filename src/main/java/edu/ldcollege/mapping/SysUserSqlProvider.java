...
import edu.ldcollege.domain.SysUserExample.Criteria;
import edu.ldcollege.domain.SysUserExample.Criterion;
...
public class SysUserSqlProvider {
    ...
    public String insertSelective(SysUser record) {
        ...
        if (record.getLocked() != null) {
            sql.VALUES("locked", "#{locked,jdbcType=CHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLocked() != null) {
            sql.SET("locked = #{record.locked,jdbcType=CHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(SysUser record) {
        ...
        if (record.getLocked() != null) {
            sql.SET("locked = #{locked,jdbcType=CHAR}");
        }
